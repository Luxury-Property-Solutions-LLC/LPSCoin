######################################################################
# Automatically generated by qmake (3.1) for LPSCoin-Qt on March 1, 2025
######################################################################

# Enable wallet support by default (matches configure.ac --enable-wallet)
...
HEADERS += src/activemasternode.h \
           ...
           src/qt/lpscoinaddressvalidator.h \
           src/qt/lpscoinamountfield.h \
           src/qt/lpscoingui.h \
           src/qt/lpscoinunits.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/qt/lpscoinaddressvalidator.cpp \
           src/qt/lpscoinamountfield.cpp \
           src/qt/lpscoingui.cpp \
           src/qt/lpscoinunits.cpp \
           ...
           src/script/lpscoinconsensus.cpp \
...
RESOURCES += src/qt/lpscoin.qrc \
             src/qt/lpscoin_locale.qrc

TRANSLATIONS += src/qt/locale/lpscoin_bg.ts \
                src/qt/locale/lpscoin_de.ts \
                src/qt/locale/lpscoin_en.ts \
                src/qt/locale/lpscoin_es.ts \
                src/qt/locale/lpscoin_fi.ts \
                src/qt/locale/lpscoin_fr.ts \
                src/qt/locale/lpscoin_it.ts \
                src/qt/locale/lpscoin_ja.ts \
                src/qt/locale/lpscoin_pl.ts \
                src/qt/locale/lpscoin_pt.ts \
                src/qt/locale/lpscoin_ru.ts \
                src/qt/locale/lpscoin_sk.ts \
                src/qt/locale/lpscoin_sv.ts \
                src/qt/locale/lpscoin_vi.ts \
                src/qt/locale/lpscoin_zh_CN.ts \
                src/qt/locale/lpscoin_zh_TW.ts
