...
RESOURCES += src/qt/lpscoins.qrc src/qt/lpscoins_locale.qrc

TRANSLATIONS += src/qt/locale/lpscoins_bg.ts \
                src/qt/locale/lpscoins_de.ts \
                src/qt/locale/lpscoins_en.ts \
                src/qt/locale/lpscoins_es.ts \
                src/qt/locale/lpscoins_fi.ts \
                src/qt/locale/lpscoins_fr.ts \
                src/qt/locale/lpscoins_it.ts \
                src/qt/locale/lpscoins_ja.ts \
                src/qt/locale/lpscoins_pl.ts \
                src/qt/locale/lpscoins_pt.ts \
                src/qt/locale/lpscoins_ru.ts \
                src/qt/locale/lpscoins_sk.ts \
                src/qt/locale/lpscoins_sv.ts \
                src/qt/locale/lpscoins_vi.ts \
                src/qt/locale/lpscoins_zh_CN.ts \
                src/qt/locale/lpscoins_zh_TW.ts
