                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Luxury Property Solutions") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a lpscoins address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and lpscoins: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About lpscoins Core"), this);
    aboutAction->setStatusTip(tr("Show information about lpscoins Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for lpscoins"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your lpscoins addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified lpscoins addresses"));
    ...
    openAction->setStatusTip(tr("Open a lpscoins: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the lpscoins Core help message to get a list with possible lpscoins command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("lpscoins Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to lpscoins network", "", count));
}
...
{
    QString strTitle = tr("lpscoins Core"); // default title
