...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("lpscoins Core"),
     ...
     * override -datadir in the lpscoins.conf file in the default data directory
     * (to be consistent with lpscoinsd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
