...
/** Utility functions used by the lpscoins Qt UI.
 */
namespace GUIUtil
{
...
// Render lpscoins addresses in monospace font
...
// Parse "lpscoins:" URI into recipient object, return true on successful parsing
