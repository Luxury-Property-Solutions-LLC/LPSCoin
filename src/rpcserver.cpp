...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop lpscoins server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "lpscoins server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* lpscoins features */
        {"lpscoins", "masternode", &masternode, true, true, false},
        {"lpscoins", "masternodelist", &masternodelist, true, true, false},
        {"lpscoins", "mnbudget", &mnbudget, true, true, false},
        {"lpscoins", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"lpscoins", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"lpscoins", "mnsync", &mnsync, true, true, false},
        {"lpscoins", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"lpscoins", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use lpscoinsd, or the -server option to lpscoins-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> lpscoins-cli " + methodname + " " + args + "\n";
}
