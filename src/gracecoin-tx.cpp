...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("lpscoins Core lpscoins-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  lpscoins-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded lpscoins transaction") + "\n" +
                               "  lpscoins-tx [options] -create [commands]   " + _("Create hex-encoded lpscoins transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded lpscoins transaction
