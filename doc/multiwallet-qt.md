...
In order to support loading of multiple wallets in lpscoins-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is lpscoins.cpp.
...
Changes to lpscoins.cpp
----------------------
lpscoins.cpp is the entry point into lpscoins-qt, and as such, will require some minor modifications to provide hooks for
